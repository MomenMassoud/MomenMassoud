...
public class MiddleSchool extends SchoolData {
   private int number;//Numbrer Of Subject
    ...
    public MiddleSchool(String FirstName, String LastName, String age, String address, String username, String password) {
